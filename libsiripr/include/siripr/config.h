#ifndef SIRIPR_CONFIG_H_
#define SIRIPR_CONFIG_H_
...
namespace siripr {
	...
	static const char* kChineseMappingPath = "resources/model/province_mapping";

	static const char* kTempImgOutputPath = "resources/image/debug/";
...
#define SHOW_IMAGE(imgName, debug) \
  if (debug) { \
	...
	// Load model compatitable with 3.0, 3.1 and 3.2
